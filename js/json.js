...
async function populate() {
    ...
    responseJson.topFlavours.push({
        name: "Strawberry Sprinkle",
        calories: 210,
        type: "Fruit-based",
        ingredients: ["Strawberries", "Milk", "Sugar", "Vanilla", "Sprinkles"],
...
responseJson.topFlavours.push(
    {
        ...
        calories: 180,
        type: "Fruit-based",
        ingredients: ["Mango", "Milk", "Sugar", "Honey"],
        image: "./images/mango-delight.svg"
    },
    {
        name: "Choco Mint",
        calories: 200,
        type: "Chocolate-based",
        ingredients: ["Dark Chocolate", "Mint Extract", "Cream", "Sugar"],
        image: "./images/choco-mint.svg"
    }
);
